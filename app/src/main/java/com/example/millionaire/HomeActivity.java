...
public class HomeActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(HomeActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void checkAnswer() {
        ...
        if (answerNb == currentQuestion.getAnswerNumb()) {
            Toast.makeText(HomeActivity.this, "This is the CORRECT Answer you earned $10000", Toast.LENGTH_SHORT).show();
            score = score + 10000;
            textViewScore.setText("You Earned: $" + score);

        }
        else {
            Toast.makeText(HomeActivity.this, "Sorry that is not the right answer!", Toast.LENGTH_SHORT).show();
        }
